...
final class FileUtil
{
    ...
    public static function makeWritable(string $filename): void
    {
        ...
        if (self::$mode === null) {
            ...
            if (!\file_exists(CFW_DIR . '/TimeMonitoring.php')) {
                throw new SystemException("Unable to find '".CFW_DIR."/TimeMonitoring.php'.");
            }

            self::$mode = '0' . \substr(\sprintf('%o', \fileperms(CFW_DIR . '/TimeMonitoring.php')), -3);
        }
