 ...
 *
 */
define(["require", "exports", "tslib", "Ajax/Status", "Core", "Dom/Listener", "Ui/Dialog", "Dom/Util"], function (require, exports, tslib_1, AjaxStatus, Core, Listener, UiDialog, Util) {
    "use strict";
    AjaxStatus = tslib_1.__importStar(AjaxStatus);
    Core = tslib_1.__importStar(Core);
    Listener = tslib_1.__importDefault(Listener);
    let _didInit = false;
    ...
    class AjaxRequest {
        ...
        constructor(options) {
            ...
            if (this._options.url.indexOf("index.php") === 0) {
                this._options.url = window.API_URL + this._options.url;
            }
            if (this._options.url.indexOf(window.API_URL) === 0) {
        ...
        getErrorHtml(data, xhr) {
            ...
            if (data !== null && data.code === 403) {
                html = "<h1 class=\"text-center mt-1 pt-1\"><i class=\"fa fa-2x color-red-dark fa fa-exclamation-triangle\"></i></h1>";
                html += "<p class=\"boxed-text mt-2 mb-0 font-13 theme-color font-600 text-center \">" + data.publicMessage + "</p>";
                return html;
            }
            ...
            if (data !== null && Object.keys(data).length > 0) {
                html = "<h1 class=\"text-center mt-1 pt-1\"><i class=\"fa fa-2x color-red-dark fa fa-exclamation-triangle\"></i></h1>";
                html += "<p class=\"boxed-text mt-2 mb-0 font-13 theme-color font-600 text-center \">" + data.publicMessage + "</p>";
                html += "<div class=\"divider divider-small mb-2 mt-2 bg-highlight opacity-60 \"></div>";
                html += "<p class=\"boxed-text mt-0 mb-0 font-11 theme-color text-center opacity-70\">Error: " + data.errorMessage + "</p>";
                html += "<p class=\"boxed-text font-11 text-center mb-2 opacity-70\">Exception ID: " + data.exceptionID + "</p>";
                return html;
