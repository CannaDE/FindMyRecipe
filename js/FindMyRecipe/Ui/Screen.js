 ...
 */
define(["require", "exports", "tslib", "Core", "Environment"],
    function (require, exports, tslib, Core, Environment) {
        "use strict";
        ...
        function pageOverlayOpen() {
            if (_pageOverlayCounter === 0) {
                document.documentElement.classList.add("dialogOverlayActive");
            }
            _pageOverlayCounter++;
        }
        ...
        function pageOverlayClose() {
            if (_pageOverlayCounter) {
                _pageOverlayCounter--;
                if (_pageOverlayCounter === 0) {
                    document.documentElement.classList.remove("dialogOverlayActive");
                }
            }
        }
